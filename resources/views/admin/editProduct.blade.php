        ...
        <div id="wrapper">
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <h1 class="text-start text-warning mb-4 pt-sm-0 mt-sm-0" style="text-align: left;font-weight: bold;font-size: 46.88px;padding-left: 23px;margin-bottom: 7px;">Edit Product</h1>
                    <div class="text-warning p-5" style="padding-left: 0px;margin-left: -24px;margin-right: -24px;padding-top: 11px;margin-top: -46px;margin-bottom: 2px;">
                        ...
                        <form class="user" action="{{ '/admin/updateProduct/'.$product->id }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3" style="margin-bottom: 142px;margin-left: 1px;margin-right: -1px;">
                                ...
                                <input class="form-control mt-sm-3" type="text" style="font-size: 18px;color: var(--bs-black);" name="nama_produk" required value="{{ $product->nama_produk }}">
                                
                                <h6 class="text-dark m-0 fw-bold mt-sm-4" style="margin-left: 15px;padding-left: 12px;font-size: 22px;">Harga</h6>
                                <input class="form-control mt-sm-3" type="number" style="font-size: 18px;color: var(--bs-black);" name="harga" min="0" required value="{{ $product->harga }}">
                                
                                <h6 class="text-dark m-0 fw-bold mt-sm-4" style="margin-left: 15px;padding-left: 12px;font-size: 22px;">Stok</h6>
                                <input class="form-control mt-sm-3" type="number" style="font-size: 18px;color: var(--bs-black);" name="stock" min="0" required value="{{ $product->stock }}"> 
                                
                                <h6 class="text-dark m-0 fw-bold mt-sm-4" style="margin-left: 15px;padding-left: 12px;font-size: 22px;">Gambar Produk</h6>
                                <input class="form-control" type="file" style="margin-top: 15px;margin-bottom: 0px;font-size: 18px;" name="gambar_produk">
                                ...
                                <textarea class="form-control" style="margin-top: 15px;margin-bottom: 25px;font-size: 18px;color: var(--bs-black);" name="deskripsi" required>{{ $product->deskripsi }}</textarea>
                                ...
                                <div class="x-dropdown dropdown pe-sm-0 ps-sm-0">
                                    <select class="form-select" style="height: 44px;font-size: 18px;width: 100%;margin-top: 11px;margin-bottom: 32px;padding-top: 0px;padding-bottom: 0px;border-color: rgb(133, 135, 150);color: var(--bs-black);" name="kategori" required>
                                        <option value="Sayur" {{ $product->kategori === 'Sayur' ? 'selected' : '' }}>Sayur</option>
