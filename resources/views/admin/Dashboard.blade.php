                                ...
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        ...
                                        <div class="col me-2">
                                            ...
                                            <div class="text-dark fw-bold h5 mb-0"><span class="text-warning">{{ $orders->count() }}</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="card shadow border-start-success py-2" style="background: var(--bs-black);">
                                <div class="card-body">
                                    <div class="row align-items-center no-gutters">
                                        ...
                                        <div class="col me-2">
                                            <div class="text-uppercase text-success fw-bold text-xs mb-1"><span class="text-white" style="font-size: 19.2px;">Total Keuntungan</span></div>
                                            <div class="text-dark fw-bold h5 mb-0"><span class="text-warning">@currency($orders->sum('total_price'))</span></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <table class="table my-0" id="dataTable">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-dark" style="text-align: center;width: 194.856px;">Bukti Pembayaran</th>
