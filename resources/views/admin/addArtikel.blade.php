        ...
        <div id="wrapper">
            ...
            <div class="d-flex flex-column" id="content-wrapper">
                <div id="content">
                    ...
                    <section></section>
                    <h1 class="text-start text-warning mb-4 pt-sm-0 mt-sm-0" style="text-align: left;font-weight: bold;font-size: 46.88px;padding-left: 23px;margin-bottom: 7px;">Add Artikel</h1>
                    <div class="text-warning p-5" style="padding-left: 0px;margin-left: -24px;margin-right: -24px;padding-top: 11px;margin-top: -46px;margin-bottom: 2px;">
                        ...
                        <form class="user">
                            <div class="row mb-3" style="margin-bottom: 142px;margin-left: 1px;margin-right: -1px;">
                                <h6 class="text-dark m-0 fw-bold" style="margin-left: 15px;padding-left: 12px;font-size: 22px;">Judul Artikel</h6><input class="form-control mt-sm-3" type="text" style="font-size: 18px;color: var(--bs-black);">
                                <h6 class="text-dark m-0 fw-bold mt-sm-4" style="margin-left: 15px;padding-left: 12px;font-size: 22px;padding-top: 0px;">Gambar Artikel</h6><input class="form-control" type="file" style="margin-top: 15px;margin-bottom: 0px;font-size: 18px;">
                                <h6 class="text-dark m-0 fw-bold mt-sm-4" style="margin-left: 15px;padding-left: 12px;margin-top: 7px;padding-top: 0px;font-size: 22px;">Deskripsi Artikel</h6><textarea class="form-control" style="margin-top: 15px;margin-bottom: 25px;font-size: 18px;color: var(--bs-black);height: 240px;"></textarea>
