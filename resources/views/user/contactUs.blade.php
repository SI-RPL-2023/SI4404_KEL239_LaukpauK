        ...
        <div class="col-md-6 col-xl-4 col-xxl-7">
          <div>
            <form class="p-3 p-xl-4" method="post">
              <div class="mb-3"><label class="form-label" for="email">Email</label><input class="form-control" type="text" id="name" name="name"></div>
              <div class="mb-3"><label class="form-label" for="subject">Subject</label><input class="form-control" type="email" id="email" name="email"></div>
              ...
              <div class="text-center mb-3"><button class="btn btn-primary" type="submit" style="width: 606px;background: #e7b10a;font-family: Nunito, sans-serif;height: 40px;font-size: 18px;"><strong>Submit</strong></button></div>
            </form>
          </div>
        </div>
